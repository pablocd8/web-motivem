                    ...
                    <div className="flex flex-col items-center text-slate-800 leading-relaxed ">
                        <section className="max-w-3xl w-full text-left">
                            ...
                            <p className="mb-8 text-lg">
                                En este taller entenderás cómo funcionan las emociones, aprenderás a reconocerlas y a gestionarlas de manera efectiva.
                            </p>
                            ...
                            <div className="mb-10">
                                <p className="text-lg italic text-slate-600 mb-2">
                                    Las emociones son una parte fundamental de nuestra experiencia humana. Aprender a manejarlas nos permite vivir de manera más plena y auténtica.
                                </p>
                                <p className="text-lg">
                                    Desarrollar la inteligencia emocional es clave para mejorar nuestras relaciones y nuestro bienestar personal.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <ul className="list-disc list-inside space-y-2 text-lg">
                                    {[
                                        "Aumentar tu conocimiento acerca de las emociones",
                                        "Identificar las emociones propias y ajenas",
                                        "Desarrollar una mayor y más eficaz gestión de las emociones, propias y ajenas",
                                        "Desarrollar una mayor estabilidad emocional",
                                        "Mejorar tu capacidad comunicativa",
                                        "Mejorar tus relaciones interpersonales",
                                        "Superar eficazmente los desafíos de la vida",
