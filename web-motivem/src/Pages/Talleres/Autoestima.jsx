                    ...
                    <div className="flex flex-col items-center text-slate-800 leading-relaxed mt-6">
                        <section className="max-w-3xl w-full text-left">
                            ...
                            <p className="mb-8 text-lg">
                                En este taller entenderás cómo funciona tu autoestima, de qué depende y cómo puedes hacer que tu autoestima mejore día a día.
                            </p>
                            ...
                            <div className="mb-10">
                                <p className="text-lg italic text-slate-600 mb-2">
                                    Todos tenemos algo que nos hace únicos y especiales, pero ¿De qué sirve todo esto si no lo vemos?
                                </p>
                                <p className="text-lg">
                                    Aprender sobre la autoestima, a la edad que sea, ayudará a valorar, aceptar y amar a la persona que eres.
                                </p>
                            </div>
                            ...
                            <ul className="space-y-3 mb-6 text-lg">
                                {[
                                    ...
                                    "Descubrir recursos personales y aprender a apreciarlos y utilizarlos",
                                    "Identificar y aceptar dificultades y aspectos más críticos",
                                ].map((item, i) => (
