...
const Register = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#efdfc2] to-[#d4c9b3] p-5">
            <div className="bg-white rounded-3xl shadow-2xl p-12 max-w-lg w-full animate-fade-in">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                    ...
                    <div className="text-center mt-5">
                        <p className="text-sm text-gray-500">
                            ¿Ya tienes cuenta?{' '}
                            <Link to="/login" className="text-[#94a3b8] font-semibold hover:text-[#64748b] transition-colors">
                                Inicia sesión aquí
                            </Link>
                        </p>
                    </div>
